...
* Criar uma nova pasta no PC `nova pasta`;

* Abrir essa pasta no VSCode;

* Criar um novo arquivo `README.md`;

* Fazer alguma alteração no `README.md`, como por exemplo: `Olá, nesse projeto você aprenderá alguns comandos do Git`;

* Salvar o arquivo.

Agora usaremos o Git:

* Abrir o Git Bash que foi instalado na máquina (pode ser pelo terminal do VSCode mesmo)

* `git init` para inicializar o repositório

Foi criada uma pasta oculta `.git` e é ali que toda a configuraçaõ do git está, portanto, não apague
...
* Este repositório foi baseado em: [repositório de Rafa Ballerini - Tutorial Git](https://github.com/rafaballerini/GitTutorial)
